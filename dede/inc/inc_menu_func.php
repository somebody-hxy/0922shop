...
require_once(DEDEINC."/dedetag.class.php");
 ...
 $headTemplet = "<dl class='leftmenu'>
        <dd><div class='title'><span><img src='images/leftico01.png' /></span>~channelname~</div><ul class='menuson'>\r\n";
...
$link = "        <div class='items'>
            <div class='fllct'>$link</div>\r\n
                ...
                <a href='".$ctag2->GetAtt('linkadd')."' target='".$ctag2->GetAtt('target')."'> </a>
